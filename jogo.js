...
function iniciaJogo(){
	...
	document.getElementById('baloes_furado').innerHTML = 0;
...
function estourar(e){
	...
	document.getElementById(id_balao).src = 'imagens/balao_azul_pequeno_furado.png';
...
function pontuacao(acao){
	...
	var baloes_estourados  = document.getElementById('baloes_furado').innerHTML;
	...
	document.getElementById('baloes_furado').innerHTML = baloes_estourados;
